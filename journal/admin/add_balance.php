...
if (isset($_REQUEST['action'])) {
  if ($_REQUEST['action'] == 'upload') {
    ...
    if ($error == '') {
      ...
      header('Location: add_balance.php?mode=success_add');
      exit();
    }
  }
}
  if ($mode == 'success_add') {
  	echo "<center>".$lang['balance_up_good']."<br /><br />";
...
<form action="balances_upload.php" method="post" enctype="multipart/form-data">
