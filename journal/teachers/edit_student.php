...
<?php
  ...
  if ($mode == 'success_update') {
  	echo '<center>'.$lang['student_update_good_q'].'.<br /><br />';
...
<form action="edit_student.php" method="post" id="studentForm">';
...
<center><br /><input type="submit" class="button" value="'.$lang['refresh'].'" />';
