...
$file_templ = "../phpexcel/schedule_templ.xls";
   ...
   $file_list  = "../phpexcel/schedule_s". $num_school ."_empty.xls";
if (LOCAL === true) {
   $file_list  = "../phpexcel/schedule_s". $num_school ."_empty.xls";
   $file_list  = "../phpexcel/schedule_s". iconv('utf-8', 'cp1251//IGNORE//TRANSLIT', $num_school."_empty.xls");
   $file_list  = "../phpexcel/schedule_s". trans($num_school."_empty.xls");
} else {
   $file_list  = "../phpexcel/schedule_s". iconv('utf-8', 'cp1251//IGNORE//TRANSLIT', $num_school."_empty.xls");
   $file_list  = "../phpexcel/schedule_s". $num_school ."_empty.xls";
   $file_list  = "../phpexcel/schedule_s". trans($num_school."_empty.xls");
