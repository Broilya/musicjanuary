#SKD101|cl25536_el|4|2011.11.23 23:06:11|10|10
...
DROP TABLE IF EXISTS `sch_schoolle_represent`;
DROP TABLE IF EXISTS `sch_school_represent`;
CREATE TABLE `sch_school_represent` (
