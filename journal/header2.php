 ...
 <table border="0" cellspacing="0" cellpadding="0" class="table_menu" style="width:200px">
  ...
  <tr>
    ...
    <td class="padding"><table>
      <tr>
        <td nowrap="nowrap">&nbsp;<a href="./students/index.php"><?php echo $lang['prosmotr_ocenok'];?></a>&nbsp;</td>
          <td align="center"><img src="images/dec.png" alt="" width="1" height="51"></td>
        <td>&nbsp;<a href="./students/information.php"><?php echo $lang['header_info'];?></a>&nbsp;</td>
        <td align="center"><img src="images/dec.png" alt="" width="1" height="51"></td>
        <td>&nbsp;<a href="./students/index.php?action=logout"><?php echo $lang['header_exit'];?></a>&nbsp;</td>
      </tr>
    </table></td>
