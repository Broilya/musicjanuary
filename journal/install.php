...
<html>
  <head>
    <title>Установка школьного журнала  <?=NAME_SCHOOL;?></title>
...
<input type="button" value="Далее" onClick="javascript:document.location='install.php?step=2';" />
</td>
</tr>
</table>
...
<?php
  ...
  include_once dirname(__FILE__).'/include/mysql_db.php';
  include dirname(__FILE__).'/install/create_tables.php';

  db_query("INSERT INTO `".TABLE_USERS."` (login, passwd, first_name, middle_name, last_name, access) VALUES ('".$_SESSION['user_name']."', '".md5($_SESSION['password'])."', '', '', '', 1);");
