...
<option value="student"><?php echo $lang['ac1'];?></option>
<option value="parent"><?php echo $lang['ac5'];?></option>        
<option value="teacher" ><?php echo $lang['ac2'];?></option>
<option value="director"><?php echo $lang['ac3'];?></option>        
<option value="admin" ><?php echo $lang['ac4'];?></option>
</select>
...
?>
<div><input type="submit" value="<?php echo $lang['main_enter'];?>" class="hugeBtn"  tabindex="4">
